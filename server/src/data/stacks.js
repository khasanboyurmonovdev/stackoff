...
export const STACKS = [
  {
    ...
    behaviorTags: ['Graceful pauses', 'Takes its time'],
  ...
  },
  {
    ...
    behaviorTags: ['Talks over you', 'Jumps in early', 'Fast responder'],
  ...
  },
  {
    ...
    behaviorTags: ['Lets you finish', 'Feels live'],
  ...
  },
  {
    ...
    behaviorTags: ['Slow to stop', 'A beat behind'],
  ...
  },
  {
    ...
    behaviorTags: ['Clean barge-in', 'Snappy responder'],
    voice: 'en_US-amy-medium',
    priceTier: '$$',
  ...
  },
  {
    ...
    behaviorTags: ['Long silences', 'Never interrupts', 'Deliberate pace'],
    voice: 'en_US-ryan-medium',
    priceTier: '$$',
